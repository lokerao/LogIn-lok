...
import { fetchHRLeaveRequests } from "@/features/leave/leave-service";
import type { LeaveRequest } from "@/types/leave";

type Filter = "pending" | "all";

export function HRLeaveReview() {
  ...
  const load = useCallback(async () => {
    ...
    setError(null);
    try {
      const data = await fetchHRLeaveRequests(
  ...
  return (
    <>
      <View style={employeeStyles.card}>
        <Text style={employeeStyles.label}>HR — Leave Requests</Text>
